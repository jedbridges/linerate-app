...
export const CROSS_HATCH: EffectConfig = {
  ...
  sizeLong: "~5KB gzipped",
  params: [
    { id: "grid", label: "Grid", min: 20, max: 240, step: 1, val: 40 },
    { id: "levels", label: "Hatch passes", min: 1, max: 6, step: 1, val: 4 },
    { id: "weight", label: "Stroke weight", min: 0.05, max: 0.5, step: 0.01, val: 0.26 },
    { id: "contrast", label: "Contrast", min: 0.5, max: 4, step: 0.05, val: 1.15 },
    { id: "exposure", label: "Exposure", min: -0.4, max: 0.4, step: 0.01, val: 0.12 },
    { id: "bleed", label: "Amber bleed", min: 0, max: 1, step: 0.01, val: 0.85 },
    { id: "focus", label: "Cursor focus", min: 0, max: 1, step: 0.01, val: 0.5 },
  ],

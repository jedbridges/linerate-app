    ...
    <ConceptChrome slug="neutral">
      ...
      <section className="mx-auto grid max-w-6xl gap-12 px-6 pt-16 pb-20 sm:pt-24 lg:grid-cols-12">
        <div className="lg:col-span-7">
          <p className="eyebrow mb-6">Neutral system of record</p>
          <h1 className="text-display-md font-semibold tracking-tight text-foreground leading-[1.05]">
          ...
          <div className="flex h-full flex-col justify-center gap-3 rounded-xl border border-border bg-surface p-6">
            <div className="rounded-lg border border-border-subtle px-4 py-3">
              ...
              <p className="mt-1 text-sm text-foreground-muted">
                Mining, hosting, AI compute
              </p>
            </div>
            <div className="flex items-center justify-center gap-2 text-foreground-subtle">
              <ArrowRight className="size-4 rotate-90" />
            </div>
            <div className="rounded-lg border border-accent bg-page px-4 py-3">
              <p className="eyebrow text-foreground">LineRate</p>
              <p className="mt-1 text-sm text-foreground-muted">
                Neutral runtime &amp; system of record
              </p>
            </div>
            <div className="flex items-center justify-center gap-2 text-foreground-subtle">
              <ArrowRight className="size-4 rotate-90" />
      ...
      <section className="border-y border-border">
        <div className="mx-auto grid max-w-6xl grid-cols-2 divide-border-subtle px-6 sm:grid-cols-4 sm:divide-x">
          {METRICS.map((m) => (
            <div key={m.label} className="py-12 sm:px-8 sm:first:pl-0">
